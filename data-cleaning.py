...
# Fill categorical columns with most frequent value (mode) in each column（we assume that the missing columns should be imputed with mode value, we would check back later
